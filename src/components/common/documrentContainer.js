...
import {UploadAndVarifyDocument ,GetEmployeeDocumentList} from "../../api/api"
...
useEffect(()=>{
  ...
  const handleFileChange = async (event,id) => {
    ...
    let response = await UploadAndVarifyDocument(props.employee_id,docName,DocFile,id)
    ...
    <div className="container document_container bg-white p-7">
      <div className="row mb-11 ">
        <div className={docName ? "col-3" : "col-12"}>
          ...
          <ListGroup defaultActiveKey="#link1">
            ...
            <ListGroup.Item
              ...
              variant="light"
              id="dropdown-basic"
              active={docName === ("education_metric" || "education_higher_secondary" || "education_graduation" || "education_post_graduation") ? true : false}
            >
              <Dropdown.Item

                onSelect={() => setDocName("education_metric")}
              >
                10th Marksheet
              </Dropdown.Item>
              <Dropdown.Item
        ...
        <div className="col-9 p-5 bg-light rounded">
          ...
          </div>{console.log("url =>",Item.document_url)}
          <FileViewer
