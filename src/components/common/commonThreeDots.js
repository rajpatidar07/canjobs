...
export default function CommonThreeDots(props) {
  ...
  return (
    <>
      {openFolderModal && props.applicantTypeId && (
        <AddFolderModal
      ...
      >
        ...
        {isOpen && (
          ...
          >
            ...
            {user_type === "admin" && (
              <div className="dropdown-item d-flex align-items-center border-0 bg-transparent">
                <ExportExcelButton
                  tableName={props.tableName}
                  type={""}
                  portal={props.portal || ""}
                  applicantType={props.applicantTypeId}
                  status={props.exportCandidatestatus}
                  local={props.local || ""}
