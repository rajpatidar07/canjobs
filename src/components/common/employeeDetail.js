  ...
  return (
    ...
    <div className="site-wrapper overflow-hidden ">
      ...
      <div
        className={
          userType === "admin"
            ? "bg-default-2 pt-5 pb-13 pb-xxl-32 mt-5"
            : "bg-default-2 pt-22 pt-lg-25 pb-13 pb-xxl-32 mt-5"
        }
      >
          ...
          <div className="row text-left mt-5 pt-5">
            <div
              className={
                userType === "admin"
                  ? "col-12 mb-3"
                  : "col-12 col-xxl-4 col-lg-4 col-md-5 mb-11 mb-lg-0 "
              }
            >
              <div className="pl-lg-5">
                ...
                <div
                  className={
                    userType === "admin"
                      ? "bg-white row shadow-9 rounded-4"
            ...
            <div
              className={
                userType === "admin"
                  ? "col-12 col-xxl-12 col-lg-12 col-md-12 order-2 order-xl-1 pr-0 "
                  : "col-12 col-xxl-8 col-lg-8 col-md-7 order-2 order-xl-1"
              }
            >
      ...
      {userType === "admin" ? null : <EmployeeFooter />}
    </div>
  );
};
