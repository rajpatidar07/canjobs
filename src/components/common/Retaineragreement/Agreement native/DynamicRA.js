...
const DynamicRA = () => {
                        ...
                        <View >
                            <View style={[styles.table,]}>
                                ...
                                {paymentRows.map((row, index) => (
                                    <View style={[styles.row, { fontSize: 8 }]} key={index} >
                                        <View style={[styles.cell]}>
                    ...
                    <View style={{ height: "auto" }}>
                        <View style={{ padding: "10px 20px" }}>
                            ...
                            <View data-list-text="5.">
                                ...
                                <View id="l6">
                                    <View style={{ marginLeft: 30, marginTop: 10 }} data-list-text="o">
                                        <Text>
                                            <Text style={{ fontWeight: "bold" }}>
                    ...
                    <View style={{ height: "auto" }}>
                        <View style={{ padding: "10px 20px" }}>
                            ...
                            <View data-list-text="8.">
                                ...
                                <Text style={{ paddingLeft: 10, marginTop: 5, }}>The RCIC will provide invoices, which include:</Text>
                                <View id="l9">
                            ...
                            <View data-list-text="9.">
                                ...
                                <Text style={{ marginTop: 10, paddingLeft: 10 }}>
                                    ...
                                    <Text className="s13" style={{ marginTop: 10, }}>
                                        website:
                                    </Text>
                        ...
                        <View style={{ padding: "0px 20px" }}>
                            ...
                            <View >
                                ...
                                <View>
                                    ...
                                    {/* Client Information */}
                                    <Text style={[styles.textBold, { marginLeft: 12, marginTop: 5 }]}>Client </Text>
                                ...
                                <View style={styles.container}>
                                    ...
                                    <View style={styles.box}>
                                        ...
                                        <View style={{ marginTop: 10 }}>
                                            ...
                                            <Text style={{ textAlign: "center", marginBottom: 5 }}>RCIC full name</Text>
                                        </View>
                                        ...
                                        <View style={{ marginTop: 5 }}>
                                            ...
                                            <Text style={{ textAlign: "center", marginBottom: 5 }}>Date</Text>
                                        </View>
                                    </View>
                                </View>
                            ...
                            <View>
                                ...
                                >
                                    <View style={[styles.clientForm, { textAlign: "center", marginTop: 15 }]}>
                                        <View style={styles.clientFormChild}>
                                            <Text style={{ margin: 0, marginBottom: 10, width: "100%", borderBottom: "1px solid black", textTransform: "capitalize" }}>
                                                {(familyJsonArray[0]?.client_first_name || "") + " " + (familyJsonArray[0]?.client_last_name || " ") || ""}
                                            </Text>
                                        ...
                                        <View style={styles.clientFormChild}>
                                            <Text style={{ margin: 0, marginBottom: 10, width: "100%", borderBottom: "1px solid black" }}>
                                                {!familyJsonArray[0]?.date_signature_client ||
    ...
    React.useEffect(() => {
        if (currentBlob && currentBlob !== blobData) {
            setBlobData(currentBlob);
        }
    }, [currentBlob, blobData]);
