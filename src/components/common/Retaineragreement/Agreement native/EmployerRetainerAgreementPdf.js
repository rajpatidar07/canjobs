...
const EmployerRetainerAgreementPdf = () => {
        ...
        <View style={{}}>
          ...
          <Text style={[styles.mb5]}>
            ...
            {felidData?.agreement_date && felidData?.agreement_date !== "0000-00-00" ? (
              <Text style={[{ borderBottomWidth: 1, borderBottomColor: "black" }, styles.underline]}>
                {!felidData?.agreement_date || felidData?.agreement_date === "0000-00-00 00:00:00" || felidData?.agreement_date === "0000-00-00" ? "" : <CommonRetainerAgreementDate _date={felidData?.agreement_date} format={"llll"} />}as
              </Text>
            ) : (
          ...
          <Text>
            ...
            <Text style={[styles.textBold, styles.mb5, styles.underline]}>
              Application for Labour Market Impact Assessment (LMIA)+ Recruitment (if applicable)
            </Text>
          </Text>
          ...
          <View style={styles.section}>
            ...
            <View>
              {[
                ...
                <Text key={index} style={styles.mt2}>
                  • {item}{'\n'}
                </Text>
              ))}
            </View>
          ...
          <View style={styles.section}>
            ...
            <View>
              {[
                ...
                "The undersigned, _______________ (Director) in their personal capacity, unconditionally and irrevocably guarantees the full and prompt payment and performance of all debts, obligations, and liabilities of _________________(Company Name) under this Agreement.",
                "In the event of default, the Creditor may proceed directly against the Guarantor’s personal assets without first exhausting remedies against the Company. The Guarantor waives any right to notice,demand, set-off, or defense.",
                "This Guarantee is continuing, absolute, and binding, and shall remain in full force regardless of any amendment, renewal, extension, or modification of this Agreement. It shall also be binding upon the Guarantor and their heirs, executors, administrators, successors, and assigns.",
          ...
          {/* 4th point */}
          <View style={styles.section}>
            <Text style={[styles.subtitle]}>4. Billing Method and Payment Terms and Conditions</Text>
            <Text style={[styles.mb5]}>The Client will be billed bya flat fee with payment bymilestones. The details of this billing method are as follows:</Text>
            <Text style={[styles.mb5]}>
          ...
          <View style={styles.section}>
            ...
            <Text styles={[{ marginBottom: 10 }, styles.mb5]}>
          ...
          {/* 14th section */}
          <View style={styles.section}>
            <Text style={[styles.subtitle]}>14. Miscellaneous </Text>
            <View>
              {[
          ...
          {/* 15th section */}
          <View style={styles.section}>
            <Text style={[styles.subtitle]}>15. Validation</Text>
            <Text styles={[styles.mb5]}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.box}>
              ...
              <Text style={styles.text}><Text style={styles.textBold}>Date:</Text> {felidData?.date_signature_rcic && felidData?.date_signature_rcic !== "0000-00-00 00:00:00" && felidData.date_signature_rcic !== "0000-00-00" ? <CommonRetainerAgreementDate _date={felidData?.date_signature_rcic} format={"DD-MM-YYYY"} /> : "________________"}</Text>
            ...
            <View style={styles.box}>
              ...
              <Text style={styles.text}><Text style={styles.textBold}>Date:</Text>  {!familyJsonArray[0]?.date_signature_client ||
                ...
                ? "________________"
                : <CommonRetainerAgreementDate _date={familyJsonArray[0]?.date_signature_client} format={"DD-MM-YYYY"} />}</Text>
            </View>
          </View>
        </View>
      </View >
...
export default EmployerRetainerAgreementPdf;
