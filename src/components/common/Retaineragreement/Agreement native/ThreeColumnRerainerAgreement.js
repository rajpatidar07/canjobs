                ...
                <View id="l1">
                    ...
                    <View data-list-text="4.">
                        ...
                        >
                            ...
                            <View style={styles.row}>
                                <View style={styles.cell}>
                                    <Text>Applicable Taxes: {felidData?.gst || "0"}%</Text>
                                </View>
                                <View style={styles.cell}>
                        ...
                        <View style={[styles.table, { marginTop: 18 }]}>
                            ...
                            <View style={styles.row}>
                                <View style={[styles.cell, { height: "280px" }]}>
                                    <Text>
                                        <Text style={{ marginTop: 10, fontSize: "10px" }}>
                                            Stage 1: Work Permit Completes upon signing the retaimer and
                                            sharing the chocklists and intake sheet with client and data gathering Filling out the forms, information verification and completeness
                                            check, preparing the application package and payment is due befoте
                                            final submission of application. Provide proof of submission to the
                                            client
                                        </Text>
                                    </Text>
                                </View>
                                ...
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>${felidData?.applicable_retainer_fee_stape_1 || "2500"}{`\n`}
                                        (Service Charges for Work Permit
                                ...
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>
                                        ${felidData?.applicable_government_processing_fee_stape_1 || "580"}{`\n`}
                                        (GovernmentApplication Fees and biometrics fee for Work Permit Applicantions for Principal Applicant and Dependent Spouse)
                                    </Text>
                                </View>
                            </View>
                            <View style={styles.row}>
                                <View style={styles.cell}>
                                    <Text style={{ marginTop: 10, marginBottom: 15, fontSize: "10px" }}>
                                        ...
                                        sheet with client Data gathering, filling out the
                                        forms, information verification and completeness
                                        check, preparing the application package and
                                        payment is due before final submission of
                                        application. Provide proof of submission to the
                                        client
                                    </Text>
                                </View>
                                ...
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>${felidData?.applicable_retainer_fee_stape_2 || "2000"}{`\n`}
                                        (Service Charges for PNP application for Work Permit Application for Principal Applicant and Dependent Spouse)
                                    </Text>
                                </View>
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>
                                        ${felidData?.applicable_government_processing_fee_stape_2 || "480"}{`\n`}
                                        (Government application fees for PNP Application es forWork Permit Application for Principal Applicant and Dependent Spouse)
                                    </Text>
                                </View>
                            </View>
                            <View style={styles.row}>
                                ...
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>Non-refundable</Text>
                                    <Text style={{ marginTop: 10, marginBottom: 28 }}>
                                        All payments made are nonrefundable and total service charges to be collected regardless, whether the client/ s withdraw from the file at this stage. The government fee and courier charges must be paid apart from professional fees payment scheduled at this stage
                                    </Text>
                                </View>
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>${felidData?.applicable_retainer_fee_stape_3 || "2000"}{`\n`}
                                        (Service Charges for Federal PR Application es for Work Permit Application for Principal Applicant and Dependent Spouse)
                                    </Text>
                                </View>
                                <View style={[styles.cell, { fontSize: "10px" }]}>
                                    <Text>
                                        ${felidData?.applicable_government_processing_fee_stape_2 || "3220"}{`\n`}
                                        (Government application fees and Biometrics fees for es for Work Permit Application for Principal Applicant and Dependent Spouse)
                                    </Text>
                                </View>
                            </View>
                        </View>
