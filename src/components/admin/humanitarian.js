    ...
    return (
        <>
            <div className="site-wrapper overflow-hidden bg-default-2">
                {/* <!-- Header Area --> */}
                <AdminHeader heading={"Humanitarian and Compassionate Cases"} />
                {/* <!-- navbar---> */}
                <AdminSidebar heading={"Humanitarian and Compassionate Cases"} />
                <div className="dashboard-main-container mt-16" id="dashboard-body">
                    <div className="container-fluid">
                        <div className="mb-18">
                            <div className="mb-4 align-items-center">
                                <div className="page___heading">
                                    <h3 className="font-size-6 mb-0">Humanitarian and Compassionate Cases</h3>
                                </div>
                                {/*<-- Search humanitarian -->*/}
