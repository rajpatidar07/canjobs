...
export default function TemporaryResident() {
    ...
    return (
        <>
            <div className="site-wrapper overflow-hidden bg-default-2">
                {/* <!-- Header Area --> */}
                <AdminHeader heading={"Temporary Resident (Visiting , Studying , Working)"} />
                {/* <!-- navbar- --> */}
                <AdminSidebar heading={"Temporary Resident (Visiting , Studying , Working)"} />
                <div className="dashboard-main-container mt-16" id="dashboard-body">
                    <div className="container-fluid">
                        <div className="mb-18">
                            <div className="mb-4 align-items-center">
                                <div className="page___heading">
                                    <h3 className="font-size-6 mb-0 Text-capitalize">temporary resident (visiting , studying , working)</h3>
                                </div>
                                {/*<-- Search temporary resident (visiting , studying , working) -->*/}
                                <div className="row m-0 align-items-center">
                                    ...
                                    <ApplicantsFilter
                                        ...
                                        // skill={props.skill}
                                        pageName={"temporary_resident_(visiting_,_studying_,_working)"}
                            ...
                            {/*<-- temporary resident (visiting , studying , working) Table -->*/}
                            <EmployeeTable
