            ...
            <div className="dashboard-main-container mt-16" id="dashboard-body">
                <div className="container-fluid">
                    <div className="mb-18">
                        ...
                        <div className="d-flex justify-content-start">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    style={{ height: "2.5rem" }}
                                    value={(e) => setSearchCandidate(e.target.value)}
                                />
                            </div>
                            ...
                            <div className="position-relative">
                                ...
                                >
                                    ...
                                    {/* Person list */}
                                    {personSearch && (
                                        <div className="d-flex justify-content-between align-items-center d-one">
                                            <Link
                                                to={""}
                        ...
                        {/* Call Log Table */}
                        <Calllogtable heading={"Daily Call log"} showAddForm={showAddItemForm}
