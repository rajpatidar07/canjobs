...
export default function ParmanentResidentCard() {
    ...
    return (
        <>
            <div className="site-wrapper overflow-hidden bg-default-2">
                {/* <!-- Header Area --> */}
                <AdminHeader heading={"Permanent Resident Cards"} />
                {/* <!-- navbar---> */}
                <AdminSidebar heading={"Permanent Resident Cards"} />
                <div className="dashboard-main-container mt-16" id="dashboard-body">
                    <div className="container-fluid">
                        <div className="mb-18">
                            <div className="mb-4 align-items-center">
                                <div className="page___heading">
                                    <h3 className="font-size-6 mb-0">Permanent Resident Cards</h3>
                                </div>
                                {/*<-- Search humanitarian -->*/}
                                <div className="row m-0 align-items-center">
                                    ...
                                    <ApplicantsFilter
                                        ...
                                        // skill={props.skill}
                                        pageName={"permanent_resident_cards"}
                                    />
                                </div>
