...
const AdminDashboard = ({ setLoginCondition }) => {
  ...
  const GetDashboardPermissionData = async () => {
    try {
      ...
      const dashboard_permission = JSON.parse(
        Response.data.dashboard_permission
      );
            ...
            >
              <div className="right_side">
                ...
                <div className="row   px-5 ">
                  ...
                  {isSidebarOpen && (
                    <div
                      className={`font-size-5 text-wrap`}
                      style={{
                        padding: "10px",
