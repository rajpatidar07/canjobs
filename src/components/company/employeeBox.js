...
function EmployeeBox(props) {
  return (
    <div className="col-xxl-4 col-xl-4 col-lg-6 col-md-6 job_box p-3" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
      {/* <!-- Single Featured Job --> */}
        ...
        <div className="row job_header m-0 align-items-center">
          <div className="media align-items-center company_box col-9 p-0">
            <Link className="text_box text-left" to={"/jobdetail"}>
              ...
              <img class="rounded-circle company_logo" src="image/user1.jpg" width="50" height="50" alt="" />
            </Link>
            <Link className="text_box text-left w-100" to={"/jobdetail"}>
              <p className="font-size-3 text-default-color line-height-2 m-0">Mathew Wade <span class="age_gender font-size-3 text-smoke">(Male 29)</span></p>
              <h3 className="mb-0 font-size-6 heading-dark-color">UI/UX Designer</h3>
            </Link>
          </div>
          <div className="media justify-content-md-end col-3 p-0">
            <a class="btn btn-secondary text-uppercase font-size-3 connect_btn" href="javacript:" data-toggle="modal" data-target="#signup">Connect</a>
          </div>
          <div className="col-md-12 p-0 mt-2">
            <ul className="d-flex list-unstyled mb-0 flex-wrap justify-content-md-start">
              ...
              <li className="mt-2 mr-8 font-size-small text-black-2 d-flex">
                <span className="mr-4" ><img src="image/icons/language.svg" alt="" /></span>
