                ...
                <div className="col-xxl-12 col-xl-9 pr-xxl-18 pr-xl-0 pr-11">
                  ...
                  <div className="">
                    ...
                    <p className="font-size-4 text-black-2 mb-7">
                      ...
                      deliver the UX and UI for the team to bring to life.
                    </p>
                    <p className="font-size-4 text-black-2 mb-7">
              ...
              <div className="row">
                <div className="col-12">
                  ...
                  <div className="media align-items-center">
                    ...
                    {/* <!-- media texts start --> */}
                    <div>
                      <h3 className="font-size-6 mb-0">Creative Director </h3>
                      <span className="font-size-3 text-gray line-height-2">
                        Facebook
                      </span>
                    </div>
              ...
              <div className="row">
                <div className="col-12">
                  ...
                  <div className="media align-items-center">
                    ...
                    {/* <!-- media texts start --> */}
                    <div>
                      <h3 className="font-size-6 mb-0">Software Engineer</h3>
                      <span className="font-size-3 text-gray line-height-2">
                        Oculus
                      </span>
                    </div>
              ...
              <div className="row mb-5">
                <div className="col-md-12">
                  <div className="media justify-content-md-start mb-6">
                    ...
                    <p className="font-size-5 text-gray mb-0">Berlyn, Uk</p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="media justify-content-md-start mb-6">
