...
import AccountDetails from "../employer/company_profile/modal/accountDetailsModal";
import CompanyDetails from "../employer/company_profile/modal/companyDetailsModal";
import KycComplianceDetails from "../employer/company_profile/modal/kycComplianceDetails";
import CompanyInfo from "../employer/company_profile/modal/companyInfoModal";
                ...
                <div className="">
                  ...
                  <div className="pt-5 text-left row">
                    ...
                    <div className="col-md-3">
                      ...
                      <p className="font-size-4 mb-8">Frontend developer</p>
                    </div>
                    <div className="col-md-3">
                      {" "}
                      <h5 className="mb-0 font-size-5 font-weight-semibold text-gray">
            ...
            >
              ...
              <div className="row">
                ...
                <div className="col-12 col-lg-4 col-md-4 col-xs-6">
                  ...
                  <div className="mb-8">
                    <p className="font-size-4">Est. Since</p>
                    <h5 className="font-size-4 font-weight-semibold">2020</h5>
                  </div>
                </div>
                {/* <!-- Single Widgets End --> */}
                {/* <!-- Single Widgets Start --> */}
              ...
              <div className="pr-xl-0 pr-xxl-22 pt-5">
                ...
                <p className="font-size-4 mb-8">
                  If you’re like most of my clients, you know creative content
                  marketing and killer copywriting are fundamental to the
                  success of your business.
                </p>
                <p className="font-size-4 mb-8">
                  But with so much to do to keep your business growing, you
                  don’t have time to learn how to write sales copy that actually
                  sells, or create a content marketing strategy that resonates
                  with your target audience.
                </p>
                <p className="font-size-4  mb-8">
                  You’ve been disappointed with your traffic and conversions so
                  far, but with an overwhelming number of things to do, you’ve
                  put off doing anything about it until now.
                </p>
                <p className="font-size-4 mb-8">
                  So you’ve come to Upwork, looking for someone that can craft
                  creative content and killer sales copy to help you reach more
                  people and make more sales.
                </p>
                <p className="font-size-4 mb-8">
                  But your troubles aren’t over just yet; it isn’t easy to find
                  someone who can create the high-quality content you need. But
                  your troubles aren’t over just yet.
                </p>
              </div>
              {/* <!-- Excerpt End --> */}
            </div>
