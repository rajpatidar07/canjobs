                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-12 col-xl-9 col-lg-9 col-md-8 col-xs-8">
                            {/* <!-- form --> */}
                            <form action="https://canjobs.com/" className="search-form">
                            ...
                            <div className="pt-12">
                                <div className="d-flex align-items-center justify-content-between mb-6">
                                    ...
                                    <div className="d-flex align-items-center result-view-type">
                                        ...
                                        <a className="heading-default-color pl-5 font-size-6 hover-text-hitgray active" href="search-list-1.html">
                                            <i className="fa fa-list-ul"></i>
                                        </a>
                                        <a className="heading-default-color pl-5 font-size-6 hover-text-hitgray" href="search-grid.html">
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="media align-items-center">
                                                    ...
                                                    <div>
                                                        <h3 className="mb-0"><a className="font-size-6 heading-default-color" href="#">Product Designer</a></h3>
                                    ...
                                    <div className="pt-9 px-xl-9 px-lg-7 px-7 pb-7 light-mode-texts bg-white rounded hover-shadow-3 ">
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="media align-items-center">
                                                    ...
                                                    <div>
                                                        <h3 className="mb-0"><a className="font-size-6 heading-default-color" href="#">UI/UX Designer</a></h3>
                                                        <a href="#" className="font-size-3 text-default-color line-height-2">Apple INC</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-6 text-right pt-7 pt-md-5">
                                        ...
                                        <div className="row pt-8">
                                            <div className="col-md-7">
                                                <ul className="d-flex list-unstyled mr-n3 flex-wrap">
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">Visual Design</a>
                                                    </li>
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">Wireframing</a>
                                                    </li>
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">Scrum</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="col-md-5">
                                    ...
                                    <div className="pt-9 px-xl-9 px-lg-7 px-7 pb-7 light-mode-texts bg-white rounded hover-shadow-3 ">
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="media align-items-center">
                                                    ...
                                                    <div>
                                                        <h3 className="mb-0"><a className="font-size-6 heading-default-color" href="#">iOS Developer</a></h3>
                                                        <a href="#" className="font-size-3 text-default-color line-height-2">Shopify</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-6 text-right pt-7 pt-md-5">
                                        ...
                                        <div className="row pt-8">
                                            <div className="col-md-7">
                                                <ul className="d-flex list-unstyled mr-n3 flex-wrap">
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">Swift</a>
                                                    </li>
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">Objective C</a>
                                                    </li>
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">X Code</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="col-md-5">
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="media align-items-center">
                                                    ...
                                                    <div>
                                                        <h3 className="mb-0"><a className="font-size-6 heading-default-color" href="#">Creative Director</a></h3>
                                                        <a href="#" className="font-size-3 text-default-color line-height-2">Facebook</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-6 text-right pt-7 pt-md-5">
                                    ...
                                    <div className="pt-9 px-xl-9 px-lg-7 px-7 pb-7 light-mode-texts bg-white rounded hover-shadow-3 ">
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="media align-items-center">
                                                    ...
                                                    <div>
                                                        <h3 className="mb-0"><a className="font-size-6 heading-default-color" href="#">Software Engineer</a></h3>
                                        ...
                                        <div className="row pt-8">
                                            <div className="col-md-7">
                                                <ul className="d-flex list-unstyled mr-n3 flex-wrap">
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">C++</a>
                                                    </li>
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">JavaScprit</a>
                                                    </li>
                                                    <li>
                                                        <a className="bg-regent-opacity-15 min-width-px-96 mr-3 text-center rounded-3 px-6 py-1 font-size-3 text-black-2 mt-2" href="#">ReactJS</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="col-md-5">
