                                      ...
                                      <div className="info_box text-left text-capitalize">
                                        {jobData.location ? (
                                          <span
                                            ...
                                            title="Current Location"
                                          >
                                            <LiaSearchLocationSolid className="mr-1 fs-6" />
                                            {jobData.your_duties},{" "}
                                      ...
                                      <div className="info_box text-left text-capitalize">
                                        {jobData.language ? (
                                          <span
                                            ...
                                            title="User Language"
                                          >
                                            <FaLanguage className="mr-1 fs-6" />
                                            {jobData.language}
                                          </span>
                                        ) : (
                                          ""
                                      ...
                                      <div className="info_box text-left text-capitalize">
                                        {jobData.address ? (
                                          <span
                                            ...
                                            title="Currently Located Country"
                                          >
                                            <FaRegAddressCard className="mr-1 fs-6" />
                                            {jobData.address}
                                          </span>
                                        ) : (
                                          ""
                              ...
                              <div className="pt-5 text-left row m-0">
                                ...
                                {jobData.corporation ? (
                                  <div
                                    ...
                                    title="Business Type"
                                  >
                                    <FaBriefcase className="mr-1 fs-6" />
                                    {jobData.corporation}
                                  </div>
                                ) : null}
                                {jobData.company_size ? (
                                ...
                                {jobData.education ? (
                                  <div
                                    ...
                                    title="Edication"
                                  >
                                    <LiaGraduationCapSolid className="mr-1 fs-6" />
                                ...
                                {jobData.role_category ? (
                                  <div
                                    ...
                                    title="Hiring for"
                                  >
                                    <FaBullhorn className="mr-1 fs-6" />
                                    {jobData.role_category}
                                  </div>
                                ) : null}
                                <div className="info_box text-left text-capitalize">
                                  {jobData.experience_required ? (
                                    ...
                                    >
                                      <BsFillEnvelopeAtFill className="mr-1 fs-6" />
                                ...
                                {jobData.salary ? (
                                  <div className="info_box text-left">
                                    ...
                                    >
                                      <b> Salary: </b>
                                      <LiaDollarSignSolid className="mr-1 fs-6" />
                                      {"  "} {jobData.salary}
                                    </span>
                                  </div>
                                ) : null}
