...
function Notifications({
  ...
  notificationApiCall,
  setNotificationApiCall,user_type
}) {
  const [show, setshow] = useState(false);
  let [totalNotif, setTotalNotif] = useState(true);
  let [notification, setNotiication] = useState([]);
  const [apicall, setApicall] = useState(false);
let loginuserId=user_type==="admin"?localStorage.getItem("admin_id"):user_type==="user"?localStorage.getItem("employee_id"):user_type==="agent"?localStorage.getItem("agent_id")
