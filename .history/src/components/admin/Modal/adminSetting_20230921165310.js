          ...
          <div>
            ...
            <div className="mb-3">
              ...
              >
                ...
                <option value={"employee_email"}>Employee's email</option>
                <option value={"employer_email"}>Employer's email</option>
                <option value={"employee_notification"}>
                  Employee's notifcation
                </option>
                <option value={"employer_notification"}>
                  Employee's notifcation
                </option>
              </select>
              {selectedOption && (
