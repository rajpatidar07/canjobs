...
function AdminSetting(props) {
  ...
  const toggleCheckbox = (permissionName) => {
                  ...
                  <li className="mb-3 col-6">
                    <div className="custom-control custom-switch">
                      <input
                        ...
                        onChange={() => toggleCheckbox("child_lmia")}
                      />
                      <label
                        className="custom-control-label"
                        htmlFor="customSwitch6"
                  ...
                  <li className="mb-3 col-6">
                    <div className="custom-control custom-switch">
                      <input
                        ...
                        onChange={() => toggleCheckbox("child_visa")}
                      />
                      <label
                        className="custom-control-label"
                        htmlFor="customSwitch7"
                  ...
                  <li className="mb-3 col-6">
                    <div className="custom-control custom-switch">
                      <input
                        ...
                        onChange={() => toggleCheckbox("child_interview")}
                      />
                      <label
                        className="custom-control-label"
                        htmlFor="customSwitch8"
                  ...
                  <li className="mb-3 col-6">
                    <div className="custom-control custom-switch">
                      <input
                        ...
                        onChange={() => toggleCheckbox("child_job")}
                      />
                      <label
                        className="custom-control-label"
                        htmlFor="customSwitch9"
