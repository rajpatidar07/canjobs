        ...
        <div className="bg-white rounded h-100 px-11 pt-10">
          ...
          <div>
            ...
            <div className="mb-3">
              ...
              {selectedOption && (
                <h6 className="text-start mt-4 text-grey">{`Admin's ${selectedOption} Preferences`}</h6>
              )}
              <ul className="list-unstyled row">
                {checkboxes.map((checkboxName, index) => (
                  <li className="mb-3 col-6" key={index}>
                    <div className="custom-control custom-switch">
                      <input
                        type="checkbox"
                        className="custom-control-input"
                        ...
                        checked={
                          checkboxName && notification[checkboxName] === 1
                        }
                        onChange={() => toggleCheckbox(checkboxName)}
                      />
                      <label
                        className="custom-control-label"
