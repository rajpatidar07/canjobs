                  ...
                  <>
                    {item.mime === "APPLICATION/PDF" ? (
                      ...
                      <div
                        ...
                        className="col d-flex align-items-center p-3 mb-3 rounded shadow bg-white position-relative htmlFileCls"
                        style={{
                          width: "85px",
                          color: "#333",
                          position: "relative",
                      ...
                      >
                        ...
                        <div className="download-icon">
                          <Link
                            ...
                            download={`data:text/html;base64,${item.data}`}
                            className="text-dark"
                          >
                            <AiOutlineDownload />
                          </Link>
                      ...
                      <Link
                        ...
                        download={"Attachment"}
                        className="border border-dark position-relative col"
