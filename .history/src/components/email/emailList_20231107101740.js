        ...
        <div className="bg-white shadow-8 datatable_div  pt-7 rounded pb-8 px-2 row m-0 p-5 ">
          ...
          <div className="table-responsive main_table_div col-md-6">
            ...
            <Link
              ...
              className="d-flex align-items-center p-3 mb-3 rounded shadow bg-white position-relative"
              style={{ width: "86px", textDecoration: "none", color: "#333" }}
            >
              <div className="mr-3">
                <img
              ...
              <div>
                <small className="font-weight-bold">HTML</small>
              </div>
              <div className="position-absolute top-0 start-100 translate-middle p-2 d-none">
                <a
                  href={`data:text/html;base64,{item.data}`}
                  download="file.html"
                >
                  <img
                    src="download-icon.png" // Replace with the actual download icon
                    alt="Download Icon"
                    style={{ width: "20px" }}
                  />
                </a>
