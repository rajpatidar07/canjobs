  ...
  const EmailData = async () => {
    ...
    try {
      ...
      if (
        ...
        userData.data === "No Mail Data Found"
      ) {
        setemailData([]);
        setIsLoading(false);
        setTotalData(0);
        ...
        setTotalData(userData.data.paginationDataCount);
        console.log(userData.data.paginationDataCount);
        // setPageToken(
        //   userData.data.paginationData
        //     ? userData.data.paginationData.nextLinks.map(
        //         (item) => item.split("=")[4]
        //         // .split("=")[
        //         //   // eslint-disable-next-line
        //         //   userData.data.paginationData.nextLinks[index].split("=")
        //         //     .length - 1
        //         // ]
        //       )
        //     : []
        ...
        // setTotalData(
        //   userData.data.paginationData
        //     ? userData.data.paginationData.totalItemCount
        //     : 0
        // );
        setIsLoading(false);
      }
