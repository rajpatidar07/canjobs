      ...
      <div className="email-list">
        ...
        >
          <div className="d-flex">
            ...
            <button
              type="button"
              className={"btn btn-outline-primary flex-end"}
              onClick={() => {
                sentEmail === "yes" ? setSentEmail("no") : setSentEmail("yes");
              }}
            >
              {sentEmail === "yes" ? (
                "Cancel"
        ...
        <div className="bg-white shadow-8 datatable_div  pt-7 rounded pb-8 px-2 row m-0 p-5 ">
          <div className="table-responsive main_table_div col-md-6 border-end border-dark">
            {isLoading ? (
              <Loader />
            ) : (
              <>
