...
import { BsFiletypePhp, BsFiletypeDocx, BsFiletypeSql } from "react-icons/bs";
              ...
              {emailData.attachments &&
                (emailData.attachments || []).map((item, index) => (
                  <>
                    ...
                    ) : item.mime === `IMAGE/${itemmime.split("/")}` ? (
                      <div
                        key={index}
                        // to={""}
                        // download={"Attachment"}
