              ...
              {emailData.attachments &&
                emailData.attachments.map((item, index) => {
                  ...
                  if (item.mime === "APPLICATION/PDF") {
                    ...
                    iconSrc =
                      "https://ssl.gstatic.com/docs/doclist/images/mediatype/icon_1_word_x16.png";
                    title = "Word";
                  } else if (item.mime === "APPLICATION/X-PHP") {
                    iconSrc =
                      "https://drive-thirdparty.googleusercontent.com/16/type/application/x-php";
                    title = "PHP";
                  } else if (item.mime === "TEXT/SQL") {
                    iconSrc = "path_to_sql_icon"; // Replace with actual path
                    title = "SQL";
                  } else if (item.mime === "TEXT/CSS") {
                    iconSrc = "path_to_css_icon"; // Replace with actual path
                    title = "CSS";
                  }
