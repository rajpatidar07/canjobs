      ...
      {isLoading ? (
        ...
        <div className="gmail-preview-container ">
          <div className="email-content">
            ...
            <div className="gmail-attachment-view">
              <h2 className="attachment-heading">Attachments</h2>
              <div className="attachment-list">
                {(emailData.attachments || []).map((attachment, index) => (
                  <>
                    {attachment.mime === "APPLICATION/PDF" ? (
                      <div className="attachment-pdf">
                        {/* <embed src={attachment.data} type="application/pdf" /> */}

                        <Link
                          onClick={() => {
                            openPDFInNewTab(attachment.data);
                          }}
                        >
                          <img
                            key={index}
                        ...
                        <a href={attachment.data} download>
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: window.atob(attachment.data),
                        }}
                      />
                    ) : (
