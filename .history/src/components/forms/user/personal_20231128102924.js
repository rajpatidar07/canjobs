...
function PersonalDetails(props) {
  ...
  const handleChange = (value) => {
    ...
    // Extract and update the editor content in your state
    const contentState = newEditorState.getCurrentContent();
    const editorContent = contentState.getPlainText(); // or use contentState.toString() for HTML

    setState({ ...state, description: editorContent });
  };
  return (
    <>
      <Modal
