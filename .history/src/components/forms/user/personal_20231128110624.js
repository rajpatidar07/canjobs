...
function PersonalDetails(props) {
  ...
  useEffect(() => {
    tinymce.init({
      ...
      plugins: ["paste", "link"],
      toolbar:
        "undo redo | formatselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link",
      setup: (editor) => {
        editor.on("change", () => {
              ...
              <form onSubmit={onUserPersonalDetailClick}>
                ...
                <div className="row pt-5">
                  ...
                  <div className="form-group col-md-12">
                    ...
                    ></textarea> */}
                    <textarea id="myTinyMCEEditor"></textarea>
