        ...
        <div className="table-responsive main_table_div">
          <table className="table table-striped main_data_table">
            ...
            <tbody>
              {(response || []).map((res) => (
                <tr>
                  <td><Link className="d-flex align-items-center">
                  <div class="d-flex profile_box gx-2"><div class="media  align-items-center"><div class="circle-36 mx-auto overflow-hidden"><img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png" alt="" class="w-100"></div></div><div class=" mb-0"><p class="m-0 text-black-2 font-weight-bold text-capitalize">Shila devi</p><p class="text-gray font-size-2 m-0 text-capitalize">F(married,32 Y)</p></div></div>
                    {res.name}</Link></td>
                  <td>{res.subject}</td>
                  <td>{res.remark}</td>
                  <td>
                  ...
                  <td>
                    <small>
                      in {moment(res.next_followup_date).toNow("dd")}
                    </small>
                  </td>
                </tr>
              ))}
