                    ...
                    <Link className="d-flex align-items-center">
                      <div class="d-flex profile_box gx-2">
                        <div class="media  align-items-center">
                          <div class="circle-36 mx-auto overflow-hidden">
                            <img
                              src={res.employee_profile_image!=""?"https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png":res.employee_profile_image.}
                              alt=""
                              class="w-100"
                            />
                          </div>
