            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {Count.active_company !== undefined
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {Count.total_interviews !== undefined
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {Count.interview_complete !== undefined
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {Count.total_follow_up !== undefined
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {Count.total_response !== undefined
