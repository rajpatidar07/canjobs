          ...
          <div className="row m-0 align-items-center pb-14">
            ...
            <div className="col-12 col-lg-6">
              <div className="text-center text-lg-left mb-13 mb-lg-0">
                <h2 className="font-size-9 font-weight-bold">Total Counts</h2>
              </div>
            </div>
            {/* <!-- Section Button --> */}
            {/* <div className="col-12 col-lg-6">
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.total_applicants === "number"
                        ? Count.total_applicants.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.applied_applicant === "number"
                        ? Count.applied_applicant.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.total_company === "number"
                        ? Count.total_company.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.active_company === "number"
                        ? Count.active_company.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.total_interviews === "number"
                        ? Count.total_interviews.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.interview_complete === "number"
                        ? Count.interview_complete.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.total_follow_up === "number"
                        ? Count.total_follow_up.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.total_lmia === "number"
                        ? Count.total_lmia.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.lmia_reject === "number"
                        ? Count.lmia_reject.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.lmia_pending === "number"
                        ? Count.lmia_pending.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {" "}
                      {typeof Count.lmia_approved === "number"
                        ? Count.lmia_approved.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.total_response === "number"
                        ? Count.total_response.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
            ...
            <div className="category_box col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary">
                    <span>
                      {typeof Count.jobs_viewed === "number"
                        ? Count.jobs_viewed.toFixed(2)
                        : "N/A"}
                    </span>
                  </p>
                </div>
              ...
              >
                ...
                <div className="text-left category_text_box">
                  ...
                  <p className="font-size-4 font-weight-bold text-secondary px-6">
                    <span>
                      {typeof Count.applied_rate === "number"
