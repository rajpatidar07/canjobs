    ...
    <>
      ...
      <div className="bg-white shadow-8 datatable_div  pt-7 rounded pb-8 px-2 ">
        <div class="btn-group mb-5" role="group" aria-label="Basic example">
          <button type="button" class={ status===1?"btn btn-primary":"btn btn-outline-primary"} onClick={()=>setStatus(4)}>New</button>
          <button type="button" class={ status===2?"btn btn-primary":"btn btn-outline-primary"} onClick={()=>setStatus(4)}>Prospect</button>
          <button type="button" class={ status===3?"btn btn-primary":"btn btn-outline-primary"} onClick={()=>setStatus(4)}>Lead</button>
