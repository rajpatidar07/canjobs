    ...
    <>
      ...
      <div className="bg-white shadow-8 datatable_div  pt-7 rounded pb-8 px-2 ">
        <div class="btn-group mb-5" role="group" aria-label="Basic example">
          <button type="button" class="btn btn-primary" onClick={()=>setStatus(4)}>Retained</button>
          <button type="button" class="btn btn-primary" onClick={()=>setStatus(5)}>Lost</button>
          <button type="button" class="btn btn-primary" onClick={()=>setStatus(6)}>Dead</button>
        </div>
