  ...
  return (
    <>
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-outline-primary" onClick={setStatus(4)}>Retained</button>
        <button type="button" class="btn btn-outline-primary" onClick={setStatus(5)}>Lost</button>
        <button type="button" class="btn btn-outline-primary" onClick={setStatus(6)}>Dead</button>
      </div>
