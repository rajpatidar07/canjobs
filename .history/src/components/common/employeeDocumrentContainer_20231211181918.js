...
export default function DocumrentContainer(props) {
  ...
  let [replyCommentClick, setReplyCommentClick] = useState(false);
                ...
                (commentsList || []).map((commentItem, index) => (
                  ...
                  >
                    ...
                    {replyCommentClick ? (
                      <form>
                        ...
                        <div style={{ position: "relative", width: "250px" }}>
                          <input
                            type="text"
                            value={replyComment || ""}
                            onChange={() => handleInputChange(e, "reply")}
                            placeholder="Comments or add others with @"
                            style={{ fontSize: "16px", width: "100%" }}
                          />
                          {filteredEmails.length > 0 && (
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            ReplyAnnotation(selectedAnnotation);
                            setAddCommentFlag(false);
                          }}
                          className="btn btn-primary"
                        >
                      ...
                      <Link onClick={() => setReplyCommentClick(true)}>
                        <FaReplyAll />
                      </Link>
                    )}
                  </div>
