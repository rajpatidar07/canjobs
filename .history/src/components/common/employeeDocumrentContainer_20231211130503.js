...
export default function DocumrentContainer(props) {
  ...
  const determineBackgroundColor = (commentItem) => {
    if (commentItem.someCondition) return "bg-primary-opacity-7";
    if (commentItem.anotherCondition) return "bg-secondary-opacity-7";
    if (commentItem.anotherCondition) return "bg-info-opacity-visible";
    if (commentItem.anotherCondition) return "bg-info-opacity-7";
    if (commentItem.anotherCondition) return "bg-orange-opacity-6";
    if (commentItem.anotherCondition) return "bg-danger-opacity-6";
    if (commentItem.anotherCondition) return "bg-light-opacity-5";
    if (commentItem.anotherCondition) return "bg-color-warning-opacity-7";
                ...
                >
                  ...
                  >
                    <div className="text-dark h4">
                      <span
                        className={`rounded-circle text-capitalize px-2 mx-2 ${determineBackgroundColor(
                          commentItem
                        )}`}
                      >
