...
export default function DocumrentContainer(props) {
 ...
 // Function to highlight the card when a flag is clicked
                      ...
                      {imageAnnotations.map((annotation, index) => (
                        ...
                        >
                          <FaFlag
                            ...
                            style={{
                              color:
                              color: isAnnotationSelected(annotation)
                              ? "pink"
                              : annotation.status === "1"
                              ? "lightgreen"
                              : "red",
          ...
          >
            ...
            <div className="d-flex flex-column">
              {(commentsList || []).map((commentItem, index) => (
                <div
                className={`card m-2 ${isAnnotationSelected(commentItem) ? "highlight-card" : ""}`}
