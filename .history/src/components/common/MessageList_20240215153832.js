...
const MessageList = ({ data, loginuser, loginusertype }) => {
  ...
  // Convert url to base 4 to download
  const UrlToBase64 = async (url) => {
    ...
    // Return a Promise that resolves to the base64 data URL
    return new Promise((resolve, reject) => {
      reader.onloadend = () => {
        const base64DataUrl = reader.result;
        resolve(base64DataUrl.split(",")[1]);
        console.log(base64DataUrl.split(",")[1]); // Extract base64 data from the URL
      };
  ...
  console.log(
    UrlToBase64(
      "https://apnaorganicstore.in/canjobs/uploads/followUp_documents/followUp_1/sunflower_hhhhhh2)_1.jpeg"
    )
  );
  return (
                    ...
                    <div className="text-center">
                      ...
                      <div className="download-icon">
                        <Link
                          ...
                          target="_blank"
                          rel="noreferrer"
                          onClick={() => UrlToBase64(message.document_url)}
                        >
                          <AiOutlineDownload />
                        </Link>
                      </div>
