...
const LocalTime = (date) => {
  ...
  const localMoment = utcMoment.tz(Intl.DateTimeFormat().resolvedOptions().timeZone;);

  // Format the local time
  const localTimeString = localMoment.format('LLL');

  return localTimeString;
};


const localTimeString = LocalTime(utcDateString, timezone);
console.log(localTimeString); // Output the local time string
