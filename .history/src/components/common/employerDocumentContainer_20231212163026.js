                  ...
                  >
                    ...
                    {(commentsReplyList || []).map(
                      (replyItem, replyIndex) =>
                        console.log(replyItem.task_id, commentItem.task_id)
                      // replyItem.task_id === commentItem.task_id && (
                      //   <div
                      //     className={`card m-2 ml-5 ${
                      //       selectedAnnotation &&
                      //       selectedAnnotation.x_axis === replyItem.x_axis &&
                      //       selectedAnnotation.y_axis === replyItem.y_axis
                      //         ? "highlighted-comment"
                      //         : ""
                      //     }`}
                      //     style={{
                      ...
                      //       {replyItem.subject_description && (
                      //         <h5 className="card-title text-break">
                      //           {replyItem.subject_description}
                      //         </h5>
                      //       )}
                      //       {replyItem.assigned_to && (
                      //         <div
                      //           style={{
                      //             borderRadius: "15px",
                      //             padding: "5px 10px",
                      ...
                      //           <Link
                      //             className="text-break"
                      //             to={`mailto:${replyItem.assigned_to}`}
                      //             style={{ marginLeft: "5px" }}
                      //           >
                      //             {`@${replyItem.assigned_to}`}
                      //           </Link>
