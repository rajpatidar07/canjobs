  ...
  return (
    <>
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-outline-primary">Retained</button>
        <button type="button" class="btn btn-outline-primary">Lost</button>
        <button type="button" class="btn btn-outline-primary">Dead</button>
      </div>
