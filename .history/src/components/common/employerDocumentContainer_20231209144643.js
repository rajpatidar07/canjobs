...
export default function EmployerDocumrentContainer(props) {
  ...
  let [hideannoForm, setHideannoForm] = useState(false);
                  ...
                  >
                    ...
                    <td className="p-3">
                      <Link onClick={() => OnDeleteDoc(item.id)}>
                        <CiTrash style={{ color: "white", fontSize: "15px" }} />
                      </Link>
                    </td>
                  </tr>
                ))
                ...
                >
                  ...
                  {!hide && docFile && docName && user_type === "admin" && (
                    <>
                      ...
                      {selectedAnnotation && hideannoForm === true ? (
                        <div
                          style={{
                            position: "absolute",
