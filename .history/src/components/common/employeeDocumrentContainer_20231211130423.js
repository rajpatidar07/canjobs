...
export default function DocumrentContainer(props) {
  ...
  const determineBackgroundColor = (commentItem) => {
    // Add your logic to determine the Bootstrap background color class based on commentItem data
    if (commentItem.someCondition) {
      return 'bg-primary-opacity-7'; // Light gray background
    } else if (commentItem.anotherCondition) {
      return 'bg-secondary-opacity-7'; // Light blue background (you can change this)
    } else if(commentItem.anotherCondition) {
      return 'bg-info-opacity-visible'; // Default to light gray
    }else if(commentItem.anotherCondition) {
      return "bg-info-opacity-7"
    }
    else if(commentItem.anotherCondition) {
      return "bg-orange-opacity-6"
    }else if(commentItem.anotherCondition) {
      return "bg-danger-opacity-6"
    }else if(commentItem.anotherCondition) {
      return "bg-light-opacity-5"
    }else if(commentItem.anotherCondition) {
      return "bg-color-warning-opacity-7"
    }else (commentItem.anotherCondition) {
      return "bg-yellow-opacity-6"
    }
  };
  return (
    <div
                ...
                >
                  ...
                  >
                    <div className="text-dark h4">
                      <span     className={`rounded-circle text-capitalize px-2 mx-2 ${determineBackgroundColor(commentItem)}`}
>
