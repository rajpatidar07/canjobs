...
//     // Check if "@" is typed
//     if (newText.includes('@')) {
//       const emailStartIndex = newText.lastIndexOf('@');
//       const emailSubstring = newText.substring(emailStartIndex + 1);

//       // Find the end index of the email (first space encountered)
//       const emailEndIndex = emailSubstring.indexOf(' ');

//       // Extract the email
//       const emailExtracted = emailSubstring.substring(0, emailEndIndex > -1 ? emailEndIndex : undefined);
...
//       <div>
//         <input placeholder="Comment before email" value={commentBefore} onChange={handleCommentBeforeChange} />
//         <span>@{email}</span>
//         <input placeholder="Comment after email" value={commentAfter} onChange={handleCommentAfterChange} />
//       </div>
