    ...
    <>
      <div className="bg-white rounded h-100 px-11 pt-7">
        <form onSubmit={onUserPersonalDetailClick}>
          {props.employeeId === "0" ? (
            <h5 className="text-center pt-2 mb-7"> Add Candidate Details</h5>
          ) : (
            <h5 className="text-center pt-2 mb-7">Update Candidate Details</h5>
          )}
          {/* FIRST LINE */}
          ...
          <div className="row pt-5">
            ...
            <div className="form-group col-md-4">
              ...
              {errors.language && (
                <span key={errors.language} className="text-danger font-size-3">
                  {errors.language}
                </span>
              )}
            </div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setState({
                        ...state,
                        is_featured:
                          state.is_featured === "" || state.is_featured === "0"
                            ? "1"
                            : "0",
                      })
                    }
