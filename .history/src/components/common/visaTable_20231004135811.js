                      ...
                      {props.heading === "Dashboard" ? (
                        ...
                        <td className=" py-5">
                          {empdata.experience === null ? (
                            ...
                            <p className="font-size-3 font-weight-normal text-black-2 mb-0">
                              {empdata.experience_required === "1-3 " ||
                              empdata.experience_required === "1-2 " ||
                              empdata.experience_required === "3-5 " ||
                              empdata.experience_required === "5-7 " ||
                              empdata.experience_required === "7+ "
                                ? "years"
                                : ""}
                            </p>
                          )}
