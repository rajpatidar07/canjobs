                ...
                (commentsList || []).map((commentItem, index) => (
                  ...
                  >
                    <p className="d-flex flex-row-reverse mt-2 mx-3">
                      {/* Add your status indicator here */}
                    </p>
                    <div className="card-body">
                      <div className="text-dark h4">
                        ...
                        >
                          {/* Your user avatar logic here */}
                        </span>
                        {commentItem.assigned_to_user_id
                          ? allAdmin.find(
                              (item) =>
                                item.admin_id ===
                                commentItem.assigned_to_user_id
                    ...
                    {/* Bootstrap Accordion for Replies */}
                    <div
                      className="accordion"
                      id={`accordion-${commentItem.id}`}
                    >
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button
                            ...
                            data-bs-target={`#collapse-${commentItem.id}`}
                            aria-expanded="true"
                            aria-controls={`collapse-${commentItem.id}`}
                          >
                            Replies
                          </button>
                        </h2>
                        <div
                          id={`collapse-${commentItem.id}`}
                          className={`accordion-collapse collapse ${
                            replyCommentClick === commentItem.id ? "show" : ""
                          }`}
                        >
                          <div className="accordion-body">
                            ...
                            <form className="comment-form x-auto flex-start">
                              ...
                              <div className="button-container mb-3">
                                <button
                                  type="button"
                                  onClick={() => ReplyAnnotation(commentItem)}
                                  className="btn-sm btn-primary rounded-pill save-comment-btn"
                                >
                                  Reply Comment
                                </button>
