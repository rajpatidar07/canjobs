...
const CheckoutForm = ({
  ...
  const handleSubmit = async (event) => {
    ...
    if (atm === 0 || atm === "" || atm === "0") {
      setErrors({
        ...errors,
        atm: "Please set the amount before payment",
      });
    } else {
      let tokenData = await AddStripePalpay(atm);
  ...
  return (
    <div>
      ...
      <button
        ...
        className="btn btn-info btn-small w-100 mb-5 mt-5 rounded-5 text-uppercase"
