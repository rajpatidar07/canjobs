...
const GoogleDrive = () => {
  ...
  useEffect(() => {
    const fetchCredentials = async () => {
      try {
        // Use the provided credentials JSON directly
        const credentials = {
          web: {
            client_id:
              "654480915922-bgepo1btfcgm8n6mlc0ea7k8nj7l4ls7.apps.googleusercontent.com",
            client_secret: "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",
            redirect_uris: [
              "http://localhost:3000",
              "http://localhost",
        ...
        // Destructure the necessary properties from the JSON
        ...
        const oAuth2Client = new OAuth2(
          client_id,
          client_secret,
          redirect_uris[0] // Assuming the first redirect URI is the main one
        );

        // Continue with the rest of your code...
        // ...

        // Example: Fetching files from Google Drive
