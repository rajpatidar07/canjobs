...
export const ADocAnnotation = async (id, type) => {
  const response = await axios.post(
    `${API_URL}admin/docTaskAdd`,
    {"task_creator_user_id":"1", "doc_id":"111", "assined_to_user_id":"1", "assigned_to":"@mayur.we2code@gmail.com", "subject":"hello world", "subject_description":"how are you", "x_axis":"389", "y_axis":"271"},
    {
      headers: {
        "Content-Type": "application/json",
        Authorization: Token,
