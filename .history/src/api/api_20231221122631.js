...
/*Paypal pay payment api */
export const AddPaymentToDataBase = async (data, user_id, amount) => {
  console.log(data);
  const response = await axios.post(
...
export const AddBrainTressPayment = async (amount, nonce, data) => {
  console.log(amount);
  const response = await axios.post(
    `${API_URL}payment/payWithBraintree`,
    {
      amount: "44",
      nonce: "tokencc_bh_j4tn24_yh786k_p3bx5m_3b6n9w_335",
      first_name: "mayur",
      last_name: "yadav",
    },
    {
